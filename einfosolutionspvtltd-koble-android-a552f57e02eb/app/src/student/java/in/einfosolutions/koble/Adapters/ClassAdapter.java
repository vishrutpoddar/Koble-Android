...
public class ClassAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ArrayList<Class2> mList = new ArrayList<>();
    ...
    public void setList(ArrayList<Class2> mList) {
        this.mList = mList;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        final Class2 item = mList.get(position);
        ...
        hItem.mTitle.setText(item.group_name);
        hItem.tvDesc.setText(item.members.size() + " members");
        hItem.tvDesc2.setText("CODE: " + item.group_code.toUpperCase());
        hItem.tvDesc3.setText(item.members.get(0).members.first_name);

        // create color drawable using group name
        ColorGenerator generator = ColorGenerator.MATERIAL;
        int color2 = generator.getColor(item.group_code);
        TextDrawable drawable1 = TextDrawable.builder()
                ...
                .toUpperCase()
                .endConfig()
                .buildRect(String.valueOf(item.group_name.charAt(0)), color2);
