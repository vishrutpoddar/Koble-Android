...
/**
 * AwesomePref -- Android-Shared-Preferences-Turbo
 *
 ...
 *Example usage:
*
 *AwesomePref tinydb = new AwesomePref(context);
*
 ...
 *
 */
public class AwesomePref {

    private SharedPreferences preferences;
    private String DEFAULT_APP_IMAGEDATA_DIRECTORY;
    private String lastImagePath = "";

    public AwesomePref(Context appContext) {
    ...
    /**
     * Saves 'theBitmap' into folder 'theFolder' with the title 'theImageName'
     * @param theFolder the folder path dir you want to save it to e.g "DropBox/WorkImages"
     * @param theImageName the title you want to assign to the image file e.g "MeAtLunch.png"
    ...
    /**
     * Creates the path for the image with title 'imageName' in DEFAULT_APP.. directory
     * @param imageName title of the image
    ...
    public Object getObject(String key, Class<?> classOfT) {
        ...
        Object value = App.gson.fromJson(json, classOfT);
        //if (value == null)
