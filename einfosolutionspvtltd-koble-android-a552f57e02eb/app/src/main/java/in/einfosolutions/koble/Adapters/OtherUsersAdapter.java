...
public class OtherUsersAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
    ...
    public OtherUsersAdapter(AppCompatActivity fragment) {
        api = new APIManager();
